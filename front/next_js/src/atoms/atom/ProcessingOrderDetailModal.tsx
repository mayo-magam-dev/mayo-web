...
interface ProcessingOrderDetailModalDetailModalProps {
  processingOrderId: string;
}

export default function ProcessingOrderDetailModal(
  props: ProcessingOrderDetailModalDetailModalProps
) {
  return (
      ...
      <div className="flex justify-center">
        <div>
          <div className="h-[15rem]  border border-black m-[1rem] p-[2rem]">
            <div className="font-bold mb-[0.5rem]">요청사항</div>
        ...
        <div className="h-[76rem] w-[50rem] border border-black m-[1rem] p-[2rem]">
